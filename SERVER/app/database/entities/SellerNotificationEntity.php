...
class SellerNotificationEntity {
    const TABLE_NAME = "sellernotifications";
    private string $id;
    private string $uid;
    ...
    public function __construct(string $uid, string $seller_uid, string $notification,  string $created_at, string $updated_at, int $status = 0) {
        $this->uid = $uid;
